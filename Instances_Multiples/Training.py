#Ce script de machine Learning écrit les coefficients des matrices d'entrainement X et Y situé dans le dossier MatricesTraining.
...
for root, dirs, files in os.walk("Training"):#Construction de X et de Y.
