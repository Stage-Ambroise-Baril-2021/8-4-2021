...
do
    ...
    ./dflat -p ../../encodings/dflat/3col/encoding.lp --tables -n normalized -e vertex -e edge --graphml-out tree0.ml < /home/ambroise/Bureau/Python_ML_Sklearn/Test_DFLAT/Instances_Multiples/Instances/instance_n20_p0.05_00$i.lp
    ...
    mv "tree$i-$j.ml" "/home/ambroise/Bureau/Python_ML_Sklearn/Test_DFLAT/Grakel/Training/Graph-10$i/tree10$i-$j.ml"
