...
do
    ...
    ./dflat -p ../../encodings/dflat/3col/encoding.lp --tables -n normalized -e vertex -e edge --graphml-out tree0.ml < /home/ambroise/Bureau/Python_ML_Sklearn/Test_DFLAT/Instances_Multiples/Instances/instance_n20_p0.10_00$i.lp
